...
| ottawa_ml_codex_v1 | Ottawa | ml | compiled | terminal_only | provider | fixed | `artifacts/paper/ottawa_ml_codex_v1` | pending | pending | pending |  |  |  | backend comparison candidate: codex_cli / gpt-5.3-codex |
| ottawa_ml_openrouter_v1 | Ottawa | ml | compiled | terminal_only | provider | fixed | `artifacts/paper/ottawa_ml_openrouter_v1` | pending | pending | pending |  |  |  | backend comparison candidate: openrouter / stepfun/step-3.5-flash:free |
| rm101_ml_codex_v1 | RM101 | ml | compiled | terminal_only | provider | fixed | `artifacts/paper/rm101_ml_codex_v1` | pending | pending | pending |  |  |  | backend comparison candidate: codex_cli / gpt-5.3-codex |
| rm101_ml_openrouter_v1 | RM101 | ml | compiled | terminal_only | provider | fixed | `artifacts/paper/rm101_ml_openrouter_v1` | pending | pending | pending |  |  |  | backend comparison candidate: openrouter / stepfun/step-3.5-flash:free |
