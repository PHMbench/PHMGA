---
experiment_id: rm101_torch_pilot_v1
dataset: RM101
graph_path: torch
phase: compiled
run_type: pilot
...
output_dir: artifacts/paper/rm101_torch_pilot_v1
bundle_evidence_dir: evidence/rm101_torch_pilot_v1
---

# Summary

`rm101_torch_pilot_v1` is a `pilot` run on `RM101` / `torch` with backend `offline_stub / n/a`. Canonical status is `accept` from the result ledger.
...
- test_accuracy: 0.125
- test_macro_f1: 0.027777777777777776

# Artifacts

- source_output_dir: `artifacts/paper/rm101_torch_pilot_v1`
