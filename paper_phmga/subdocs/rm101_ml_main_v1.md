---
experiment_id: rm101_ml_main_v1
dataset: RM101
graph_path: ml
phase: compiled
run_type: main
...
output_dir: artifacts/paper/rm101_ml_main_v1
bundle_evidence_dir: evidence/rm101_ml_main_v1
---

# Summary

`rm101_ml_main_v1` is a `main` run on `RM101` / `ml` with backend `pending / pending`. Canonical status is `pending` from the result ledger.
...
- source_output_dir: `artifacts/paper/rm101_ml_main_v1`
