...
OUTPUT_DIR="${PHMGA_OUTPUT_DIR:-artifacts/paper/rm101_torch_pilot_v1}"

echo "Running RM101 torch pilot wrapper..."
...
python main.py +runs=rm101_torch_test llm.mode=offline_stub runtime.output_dir="$OUTPUT_DIR"
