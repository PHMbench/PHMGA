...
OUTPUT_DIR="${PHMGA_OUTPUT_DIR:-artifacts/paper/ottawa_ml_pilot_v1}"

echo "Running Ottawa ML pilot wrapper..."
echo "Pilot uses offline_stub by design."
python main.py runtime.action=preflight +runs=ottawa_ml_test llm.mode=offline_stub
python main.py +runs=ottawa_ml_test llm.mode=offline_stub runtime.output_dir="$OUTPUT_DIR"
