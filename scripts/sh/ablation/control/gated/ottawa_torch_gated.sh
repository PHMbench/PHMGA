...
OUTPUT_DIR="${PHMGA_OUTPUT_DIR:-artifacts/paper/ottawa_torch_gated_v1}"

phmga_log_provider_choice
python main.py +runs=ottawa_torch "${PHMGA_PROVIDER_ARGS[@]}" model.torch.phase=learnable_control model.torch.control.default_mode=gated runtime.output_dir="$OUTPUT_DIR"
