...
OUTPUT_DIR="artifacts/paper/rm101_torch_attention_v1"

python main.py +runs=rm101_torch model.torch.phase=learnable_control model.torch.control.default_mode=attention model.torch.control.attention_heads=2 runtime.output_dir="$OUTPUT_DIR"
