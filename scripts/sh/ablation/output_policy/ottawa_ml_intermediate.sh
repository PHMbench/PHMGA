...
OUTPUT_DIR="${PHMGA_OUTPUT_DIR:-artifacts/paper/ottawa_ml_intermediate_v1}"

phmga_log_provider_choice
python main.py +runs=ottawa_ml "${PHMGA_PROVIDER_ARGS[@]}" model.ml.output_policy=include_intermediate_features runtime.output_dir="$OUTPUT_DIR"
