...
OUTPUT_DIR="artifacts/paper/rm101_ml_intermediate_v1"

python main.py +runs=rm101_ml model.ml.output_policy=include_intermediate_features runtime.output_dir="$OUTPUT_DIR"
