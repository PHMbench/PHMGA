...
OUTPUT_DIR="${PHMGA_OUTPUT_DIR:-artifacts/paper/ottawa_torch_module_runtime_v1}"

phmga_log_provider_choice
python main.py +runs=ottawa_torch "${PHMGA_PROVIDER_ARGS[@]}" model.torch.phase=module_runtime model.torch.module_runtime.enabled=true runtime.output_dir="$OUTPUT_DIR"
