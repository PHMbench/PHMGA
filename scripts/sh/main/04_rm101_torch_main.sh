...
PREREQ="artifacts/paper/rm101_torch_pilot_v1/final_report.md"
OUTPUT_DIR="${PHMGA_OUTPUT_DIR:-artifacts/paper/rm101_torch_main_v1}"

phmga_assert_file "$PREREQ"
phmga_log_provider_choice
python main.py +runs=rm101_torch "${PHMGA_PROVIDER_ARGS[@]}" runtime.output_dir="$OUTPUT_DIR"
