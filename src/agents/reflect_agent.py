...
"""Agent that evaluates whether the generated insights are sufficient."""
...
class Reflection(BaseModel):
    """Structured output capturing the reflection decision."""
...
def reflect_agent(state: PHMState) -> dict:
    """Determine whether the analysis should continue or conclude.

    Parameters
    ----------
    state : PHMState
        Current state containing accumulated insights.

    Returns
    -------
    dict
        Mapping with ``needs_revision`` (bool) and updated ``reflection_history``.
    """
